...
LIB_API int test_detector_image(char *datacfg, char *cfgfile, char *weightfile, image m, float thresh,
    float hier_thresh, int dont_show, int print_labels, int expected_class_id);
